...
<head>
  ...
  margin-top: 1%;" src="imagenes/logo-blanco.png" alt="logo" />
      ...
      <main>
          ...
          <div style="display: inline-flex; margin-left: 52px;  "class="">
            <nav style="margin: 0; font-size: 12px; width:100%; overflow:hidden;">
              <ul style="margin: 0; padding: 0 ">
                <li><a 	href="HomeAgentLean.php?email=<?php echo $email_pass; ?>">INICIO</a></li>
                <li><a	href="AddEvent.php?email=<?php echo $email_pass; ?>">REGISTRO</a></li>
              </ul>
        ...
        <form class="" action="AddEvent.php?email=<?php echo $email_pass;?>" onsubmit=" return validateform()" method="post">
        ...
        <div class="innercontactdiv">
          ...
          <div class="innermostcontactdivinline">
            <div class="icdiv1">
              ...
              <input type="text" name="date" id="date" value="<?php if(isset($_POST['date'])) echo $_POST['date']; ?>" placeholder="yyyy/mm/dd" required>
              <p id="datemsg"> </p>
            </div>
            <div class="icdiv1">
          ...
          <button style="margin-left: 40%; margin-top: 10px; height: 35px; width: 100px;  margin-bottom: 40px;" class="button1"type="submit" name="addevents"><small>Guardar</small></button>
        </div>
      </div>
    </form>
    </main>
