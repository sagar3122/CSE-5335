...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/>
  ...
  margin-top: 1%;" src="imagenes/logo-blanco.png" alt="logo" />
          <h1>LEANEVENTOS</h1>
          <nav style=" margin-left: 14%; margin-top: 2%;">
            <ul style=" font-size: 10px;">
              ...
              <li><a	href="BuyFromUs1.html">Comprar Boletos</a></li>
            </ul>
          </nav>
        </div>
      </header>
      <main>
        ...
        <div class="smallbox">
          <div class="innersmallbox">
            ...
            <button style="width: 80px; margin-left: 40%; margin-bottom: 50px; " class="button1"type="button" name="button">Entra</button>
          </div>
        </div>
        </main>
