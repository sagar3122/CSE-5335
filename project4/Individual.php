<?php
  ...
  {
    $errors_individual = array();
    if(empty($_POST['email']))
    {
      $errors_individual['email1'] = "Your email cannot be empty";
    }
    else
    {
      ...
      {
        $errors_individual['email2'] = "Your email should be in the format (Ex: abc@xyz.com)";
      }
    }

    if(empty($_POST['fname']))
    {
      $errors_individual['fname1'] = "Your first name can not be empty";
    }
    else
    {
      ...
      {
        $errors_individual['fname2'] = "Your first name should all be characters";
      }
    }

    if(empty($_POST['lname']))
    {
      $errors_individual['lname1'] = "Your last name can not be empty";
    }
    else
    {
      ...
      {
        $errors_individual['lname2'] = "Your last name should all be characters";
      }
    }

    if(empty($_POST['password']))
    {
      $errors_individual['password1'] = "Your password should not be empty";
    }
    else
    {
      ...
      {
        $errors_individual['password2'] = "Your password must be at least 8 characters but no more than 16 characters long.";
    ...
    {
      $errors_individual['address1'] = "Your address can not be empty";
    }
    if(empty($_POST['city']))
    {
      $errors_individual['city1'] = "Your city can not be empty";
    }
    if(empty($_POST['state']))
    {
      $errors_individual['state1'] = "Your state can not be empty";
    }
    if(empty($_POST['ZipCode']))
    {
      $errors_individual['ZipCode1'] = "Your zipcode can not be empty";
    }
    else
    {
      ...
      {
        $errors_individual['ZipCode2'] = "Your ZipCode should be 5 digits";
      }
    }
  }
 ?>
...
<?php
 ...
 <?php
 if(isset($errors_individual["fname1"]))
 {
   echo $errors_individual["fname1"];
 }
 else if(isset($errors_individual["fname2"]))
 {
   echo $errors_individual["fname2"];
 }
  ?>

  <?php
  if(isset($errors_individual["email1"]))
  {
    echo $errors_individual["email1"];
  }
  else if(isset($errors_individual["email2"]))
  {
    echo $errors_individual["email2"];
  }
   ?>

   <?php
   if(isset($errors_individual["lname1"]))
   {
     echo $errors_individual["lname1"];
   }
   else if(isset($errors_individual["lname2"]))
   {
     echo $errors_individual["lname2"];
   }
    ?>

    <?php
    if(isset($errors_individual["ZipCode1"]))
    {
      echo $errors_individual["ZipCode1"];
    }
    else if(isset($errors_individual["ZipCode2"]))
    {
      echo $errors_individual["ZipCode2"];
    }
     ?>

     <?php
     if(isset($errors_individual["password1"]))
     {
       echo $errors_individual["password1"];
     }
     else if(isset($errors_individual["password2"]))
     {
       echo $errors_individual["password2"];
     }
      ?>

      <?php
      if(isset($errors_individual["address1"]))
      {
        echo $errors_individual["address1"];
      }
       ?>

       <?php
       if(isset($errors_individual["city1"]))
       {
         echo $errors_individual["city1"];
       }
        ?>

        <?php
        if(isset($errors_individual["state1"]))
        {
          echo $errors_individual["state1"];
        }
         ?>
