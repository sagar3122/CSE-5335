...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/>
  ...
  <main>
    <table style="margin-bottom: 20px; ">
      <caption>Lista de Fundaciones</caption>
      <thead>
        <tr>
          <th style="text-align: center;" colspan="10">Nombre de la Fundaciones</th>
          <th style="text-indent: 15px;">Evento</th>
          <th style="text-indent: 5px;">Responsable</th>
          <th style="text-align:center; ">Comision</th>
          <th style="text-indent: 5px;">Confirmar</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td> <img src="imagenes/nologo.png" alt="nologo"> </td>
          ...
          <td><div class="tablediv"><p class="ptablediv">1</p>

          </div></td>
          <td> <button class="button1" type="button" name="button">
            Asignar
          </button></button> </td>
        </tr>
